...
public class ClassHelperUtils {
	...
	public static Object getObjectByConstructor(String className, Object[] args) throws ClassNotFoundException,
			IllegalAccessException, InvocationTargetException, InstantiationException, NotSuchConstructor {
